...
@AndroidEntryPoint
class AddBuyActivity : AppCompatActivity(), BottomSheetDialog.OpenActivity,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toolbar.title = "Rajouter un bien en vente"
        binding.priceEstate.hint = "Prix"
    ...
    private fun addEstate() {
        with(binding) {
            ...
            if (check == 0) {
                ...
                viewModel.geocode.observe(this@AddBuyActivity, {

                    Log.d("blop", "fini l'observe")

                    val estate = RealEstate(
                        buyOrLoc = BuyOrLoc.BUY,
                        type = typeEstate,
                    ...
                    viewModel.insertDao(estate).observe(this@AddBuyActivity, { dateEntry ->
                        var intent = Intent(
                            this@AddBuyActivity,
